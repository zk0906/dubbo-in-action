...
public interface RegistryService {
     ...
     *
     * @param url   订阅条件，不允许为空  如：consumer://10.20.153.10/com.alibaba.foo.BarService?version=1.0.0&application=kylin  Subscription condition, not allowed to be empty, e.g. consumer://10.20.153.10/org.apache.dubbo.foo.BarService?version=1.0.0&application=kylin
     * @param listener  变更事件监听器，不允许为空 A listener of the change event, not allowed to be empty
     */
